...
export const Menu_Packs = [
    {
        id: 1,
        'name': 'Standar',
        'breakfast': 'Pancakes and Maple Syrup with some Bacon and Eggs and Fruit Smoothie or Orange juice',
        'lunch': 'Fajitas with tortillas or Cornbread and Baked beans with natural juice or soda',
        'diner': 'Spaghetti topped with meat sauce optional 2 eggs on top and Mashed potatos, includes bottle of wine or other drinks',
        'description': 'This is the most selected package, includes de essential for a wheek of vacation, dishes can be modified (previous notice of 2 days).',
        'history': 'They probably arose from the heritage of the Spanish tortilla. Similar to a fritada, the egg is beaten and cooked in a pan with oil, along with chopped tomato, onion and green, jalapeño or serrano peppers.',
        'main_ingredients': '',
